...
<script src="<@wp.resourceURL />entando-mf-conf-template/static/js/2.a356bc67.chunk.js"></script>
<script src="<@wp.resourceURL />entando-mf-conf-template/static/js/main.4caa0dfa.chunk.js"></script>
...
<my-widget selectedTemplateId="${configSelectedTemplateId}" selectedContentId=${configSelectedContentId} />
